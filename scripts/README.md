...
| **`deploy_to_jetson.sh`** | Builds and deploys the new image or synchronizes the local workspace with the Jetson workspace without image rebuild. | [Read Docs](../docs/scripts/deploy_to_jetson.md) |

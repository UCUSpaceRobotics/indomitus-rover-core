...
2. Create hotspot `ERC_UCUSpaceRobotics_A` with password `19283746` and force the connection name to be `Hotspot`. Replace `wlx00c0caba86c1` in the command with the copied name:
